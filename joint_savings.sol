...
contract JointSavings {
    ...
    */
    //The variables for contract are declared
    address payable accountOne; //payble account address public
    address payable accountTwo; //payable second account public 
    address public lastToWithdraw; //The account which made the withdrawal last
    uint public lastWithdrawAmount; //The amount that was withdrawn last
    uint public contractBalance; //Current balance of the contract
    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        */
        ...
        //this will check if the funds are withdrawn to one of the listed accounts in the joint account. If account is invalid an error wil be displayed
        ...
        */
        ...
        //This checks if the joint account can fund the current withdrawal amount
        /*
        ...
        */
        //this condition will set the recipient if last withdrwal is not performed by the recipient
